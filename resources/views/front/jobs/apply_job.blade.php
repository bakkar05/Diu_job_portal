...
<div class="row">
  <div class="col-md-8">
    ...
    <center><h5 style="color: red;"><a href="{{url('/user_login')}}">Login First</a> </h5></center>

    @else

    <center><h5 style="color: red;"><a href="{{url('/apply_now/'.$login_yes.'/'.$job_id)}}" class="btn btn-success">Apply now</a></h5></center>
