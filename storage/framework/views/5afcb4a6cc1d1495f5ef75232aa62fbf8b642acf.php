    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <a href="<?php echo e(url('add_job_posts')); ?>" class="btn btn-primary">Add Job Posts </a>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a href="<?php echo e(url('/edit_jobPost/'.$datas->id)); ?>" class="btn btn-block btn-outline-success edit">Edit</a>
                      <a href="<?php echo e(url('Deltete_jobPost/'.$datas->id)); ?>" class="btn btn-block btn-danger delete">Delete</a>
                      <a href="<?php echo e(url('approve_post/'.$datas->id)); ?>" class="btn btn-block btn-primary ">Approve</a>
                      <a href="<?php echo e(url('upapprove_post/'.$datas->id)); ?>" class="btn btn-block btn-info ">Upapprove</a>
                  </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/jobs/jobs.blade.php ENDPATH**/ ?>