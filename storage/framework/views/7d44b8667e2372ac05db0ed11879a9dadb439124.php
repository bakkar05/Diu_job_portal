...
<!-- /.card-header -->
<form action="<?php echo e(url('/upload_cv')); ?>" method="post" enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
  ...
  <span class="btn btn-primary col-md-2" onclick="myFunction_profile()" id="myDIV">Submit<span id="add_word"></span> from Profile  </span><br><br>
  <span class="btn btn-info col-md-2" onclick="myFunction_cv()">Upload CV</span><br>
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/front/jobs/apply_here.blade.php ENDPATH**/ ?>