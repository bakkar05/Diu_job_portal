...
<form action="<?php echo e(url('/registration_2')); ?>" method="post" onsubmit="return app_form_validator(this)" name="app_form" id="app_form" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\blog\resources\views/front/login/registration_view.blade.php ENDPATH**/ ?>