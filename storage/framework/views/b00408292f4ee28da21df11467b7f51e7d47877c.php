        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo e(url('/update_category_job')); ?>" method="post">
              	<?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/category/edit_category.blade.php ENDPATH**/ ?>