    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('/applicants')); ?>" class="nav-link">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td> <?php if($datas['send_message'] !='' ): ?> Message Sent  <?php endif; ?> <?php if($datas['send_message'] =='' ): ?> <a href="<?php echo e(url('/send_message/'.$datas['user_id'].'/'.$data->id.'/'.$job_post_id)); ?>" class="btn btn-primary">  Send  </a> <?php endif; ?> </td>
                  <td><a href="<?php echo e(url('/'.$datas['cv'])); ?>">User CV </a></td>
                </tr>
...
</script><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/company/job_applicants.blade.php ENDPATH**/ ?>