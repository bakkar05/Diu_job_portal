        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo e(url('/store_category_job')); ?>" method="post">
              	<?php echo csrf_field(); ?>
                <div class="card-body">
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/category/add_category.blade.php ENDPATH**/ ?>