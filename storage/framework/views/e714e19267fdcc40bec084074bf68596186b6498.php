          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo e($datas->txtCompanyName); ?></td>
                  <td><?php echo e($datas->Country); ?></td>
                  <td><?php echo e($datas->business_license_no); ?></td>
                  <td><?php echo e($datas->txtContactEmail); ?></td>
                  <td><?php echo e($datas->website_url); ?></td>
                  <td>
                      <a href="<?php echo e(url('/company_jobPost/'.$datas->id)); ?>" class="btn btn-block btn-outline-success edit">Edit</a>
                      <a href="<?php echo e(url('company_jobPost/'.$datas->id)); ?>" class="btn btn-block btn-danger delete">Delete</a>
                  </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/record/company.blade.php ENDPATH**/ ?>