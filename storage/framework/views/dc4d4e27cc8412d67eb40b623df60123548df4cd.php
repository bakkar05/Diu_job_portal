    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('/self_view/'.$data->id)); ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo e(url('/view_profile_company/'.$data->id)); ?>" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Company Name : <?php echo e($data->txtCompanyName); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <p>Total job posts : <?php echo e($post_yet); ?></p><br><br>
        <div class="row">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td><?php echo e($datas->name); ?></td>
            <td><?php echo e($datas->publish_on); ?></td>
            <td><?php echo e($datas->deadline); ?></td>
            <td><?php echo e($datas->work_type); ?></td>
            <td><?php echo e($datas->location); ?></td>
            <td>
                <a href="<?php echo e(url('/view_all_applicants/'.$datas->id)); ?>" class="btn btn-block btn-outline-success edit">View Applicants</a>
            </td>
          </tr>
...
</script><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/company/index.blade.php ENDPATH**/ ?>