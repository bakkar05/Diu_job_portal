...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo e(url('/view_profile_company/'.$company_id)); ?>" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
        	<p>Send Confirmation  to  <?php echo e($datas->name); ?></p> <br>

        	<form action="<?php echo e(url('send_sms')); ?>" method="post" >
        		<?php echo csrf_field(); ?>
        		<input type="hidden" name="user_id" value="<?php echo e($datas->id); ?>">
        		<input type="hidden" name="company_id" value="<?php echo e($company_id); ?>">
            <input type="hidden" name="jobs_post_id" value="<?php echo e($jobs_post_id); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/company/send_sms.blade.php ENDPATH**/ ?>