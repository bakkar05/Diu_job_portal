...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <a class="btn-danger" href="<?php echo e(url('/logout')); ?>" >Logout</a>
  </nav>
  <!-- /.navbar -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <a href="<?php echo e(url('add_job')); ?>" class="btn btn-primary">Add Job Category </a>
...
<?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/applicants/index.blade.php ENDPATH**/ ?>