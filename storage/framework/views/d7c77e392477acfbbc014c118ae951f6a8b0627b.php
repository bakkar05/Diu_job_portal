            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a href="<?php echo e(url('/edit_user/'.$datas->id)); ?>" class="btn btn-block btn-outline-success edit">Edit</a>
                      <a href="<?php echo e(url('Deltete_user/'.$datas->id)); ?>" class="btn btn-block btn-danger delete">Delete</a>
                  </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/record/general_user.blade.php ENDPATH**/ ?>